<div class="top-left">
    <div class="navbar-header" style="">
        ...
        <!-- <p class="usernameGet" style="font-size: 15px;font-weight: 500;line-height: 53px;color: #c1b625;font-weight: 600;"></p> -->
        <a href="index.php"
            style="font-size: 14px;font-weight: bold;color:red;text-decoration: none;float: right;position: relative;right: 20px;top: 25px;"><i
                class="fa fa-power-off" style="margin-right: 9px;color:red;"></i>Logout</a>
        <p class="username"></p>
    ...
    <div class="row">
        ...
        <div class="card col-sm-3 auditdiv">
            <a href="audit/Dashboard.php" class="auditenable">
...
<script>
    $(document).ready(function () {
        ...
        // if(plantname == 'FTO3'){
        //        $('.results_cls').prop('disabled',true)
        //        $('.results_cls').attr("disabled","disabled");
        // }
        ...
        if (plantname != 'FTO2' && plantname != 'CTO2' && plantname != 'CTO6' && plantname != 'CTOSEZ' &&
            plantname != 'FTO7' && plantname != 'FTO9' && plantname != 'FTO3' && plantname != 'FTOPU1' &&
            plantname != 'FTOPU2' && plantname != 'FTO6' && plantname != 'FTO8' && plantname != 'CTO1' &&
        ...
        function allowGuestUser(username, audit_id, plant, flagType) {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    login_obj = {}
                    login_obj.role = Role_update || 'guest';
        ...
        // sessionStorage.setItem("plantname", "CTO6")
