        ...
        <li class='sub-menu'>
          ...
          <ul class="nav navbar-nav">
            ...
            <?php if ($role == 'Administrator'): ?>
              ...
              <?php if (strpos($accessString, "ConfigurationPage") > -1): ?>
                <li class="<?php if ($urlName == 'ConfigurationPage'): ?>
                            active 
                            <?php endif; ?>">
                  <a href="ConfigurationPage.php">
                    <i class="menu-icon fas fa-file-contract" data-toggle="tooltip" data-placement="right"
                      title="ConfigurationPage"></i>Configuration</a>
                </li>
              <?php endif; ?>
            <?php endif; ?>
            <?php if ($role == 'Administrator'): ?>

              <?php if (strpos($accessString, "Clientconfiguration") > -1): ?>
                ...
                <li class="<?php if ($urlName == 'Clientconfiguration'): ?>
                  ...
                  <a href="Clientconfiguration.php">
                    <i class="menu-icon fas fa-file-contract" data-toggle="tooltip" data-placement="right"
                      title="Client Configuration"></i>Client Configuration</a>
                </li>
              <?php endif; ?>
            <?php endif; ?>
