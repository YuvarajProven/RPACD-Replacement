    ...
    <div class="force-overflow">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="AddConfigKey">Config Key <span style="color:red;">*</span></label>
                                                                        <input type="text" class="form-control"
                                                                            id="AddConfigKey">

                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="AddConfigValue">Config
                                                                ...
                                                                <div class="row mb-4" style="margin-top:18px;">

                                                                    <div class="col-md-6">
                                                                        <label for="AddConfigSection">Config
                                                                            Section <span style="color:red;">*</span></label>
                                                                        <input type="text" class="form-control"
                                                                            id="AddConfigSection">
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="AddConfigDescription">Config
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">Edit Field Configuration Name</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="editedConfigValue">Config Value:</label>
                        ...
                        <div class="row mb-4 mt-4">
                            <div class="col-md-6">
                                <label for="editedConfigSection">Config Section:</label>
                                <input type="text" class="form-control" id="editedConfigSection" disabled>
                            </div>
                            <div class="col-md-6">
                                <label for="editedConfigDescription">Config Description:</label>
                                <input type="text" class="form-control" id="editedConfigDescription">
                            </div>
                        </div>

                        <div class="modal-footer">
                            <button type="button" class="savebtnPriority"
                                onclick="saveEditedConfigValue()">Submit</button>
