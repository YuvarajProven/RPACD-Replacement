...
$(document).ready(function($) {
  ...
  function startAndEndOfWeek(date) {
    ...
    // now = "Sat Jul 01 2023 00:00:00 GMT+0530 (India Standard Time)"
    var start_date = new Date(now);
    console.log("start_date before setDate: " + start_date)
    start_date.setDate(start_date.getDate() - start_date.getDay()+1);
    console.log("start_date after setDate: " + start_date)

    // Get next Sunday
    var end_date = new Date(now);
    console.log("end_date before setDate:" + end_date)
    end_date.setDate(end_date.getDate() - end_date.getDay() + 7);
    console.log("end_date after setDate:" + end_date)
      ...
      success: function (msg) {
        ...
        try {
          ...
          for (var i = 0; i < msg[0].length; i++) {
            ...
            fc_arr.push(Number(msg[0][i].FullSSCount))
            // dates_arr.push(modifiedDate)
          }
          ...
          for (var i = 0; i < msg[1].length; i++) {
            ...
            fi_arr.push(Number(msg[1][i].PassConfirmedCount))
          }
          ...
          for (var i = 0; i < msg[2].length; i++) {
            ...
            pc_arr.push(Number(msg[2][i].FailConfirmedCount) || 0);  
        }
        // console.log("Length of msg[2]:", msg[2].length);
        ...
        //     modifiedDate = dateFormat1(msg[3][i].ValidatedDate);
        //   if (modified[modifiedDate] == undefined) {
        //     modified[modifiedDate] = {};
        //   }
        //   modified[modifiedDate].RemainingCount = Number(msg[3][i].RemainingCount);
        // }
          // console.log(modified);
          // console.log(fi_arr,fc_arr,pc_arr);
          // console.log(dates_arr);
          // for(let i = 0; i < fc_arr.length; i++)
          // {
          //   if(fi_arr[i] == undefined)
          //   {
          //       temp = 
          //   }
          // }
        ...
        $('.chart_here').append('<canvas id="bar-chart" style="width:100%" height="250" margin-left: "9px";></canvas>');
          ...
          for (var i = 0; i < week_dates.length; i++) {
            ...
            if (modified[modifiedDate] != undefined) {
              ...
              Remainingval = totalval - passval - failval

              obj.remaining.push(Remainingval)
    ...
    try {
      ...
      var barChartData = {
        ...
        },
        {
          ...
          backgroundColor: "#f39aa1",
          data:datasetss.remaining
        }]
      };
