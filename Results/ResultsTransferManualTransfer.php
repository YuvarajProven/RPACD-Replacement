...
<!-- Header-->
        ...
        <div class="col-md-12 nopadding">
          <div class="card">
            <div class="card-header">
              <div class="row">
                            <div class="col-sm-12">
                              <a id="163" class="viewAddManual pointer" style="display:block">Add Manual Transfer Sample Set</a>
                            </div>
              </div>
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Add Manual Transfer Sample Set</h4>
                                      </div>
  ...
  <script src="js/ResultsTransferManualTransfer.js"></script>
