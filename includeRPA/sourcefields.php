...
include 'connect.php';  // Ensure 'connect.php' contains valid database connection

try {
    // Correctly call the stored procedure using EXEC
    $sth = $conn->prepare("EXEC COA_SourceDetails");  // Use EXEC for SQL Server stored procedure
